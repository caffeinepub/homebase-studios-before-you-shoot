...
export class Backend implements backendInterface {
    ...
    async getBookingInformation(): Promise<BookingInformation> {
        if (this.processError) {
            try {
                const result = await this.actor.getBookingInformation();
                return result;
            } catch (e) {
                this.processError(e);
    ...
    async getContactInformation(): Promise<ContactInformation> {
        if (this.processError) {
            try {
                const result = await this.actor.getContactInformation();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
