...
const Armchair = createLucideIcon("armchair", __iconNode$q);
/**
 * @license lucide-react v0.511.0 - ISC
 *
 * This source code is licensed under the ISC license.
...
function GoldDivider() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "gold-divider my-0", "aria-hidden": "true" });
}
function Section({
  id,
  children,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "section",
      {
        id,
        ref,
        className: `section-reveal ${visible ? "visible" : ""} py-16 md:py-24 px-6 md:px-12 lg:px-24 ${className}`,
        children
      }
    )
  ] });
...
function SectionHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 md:mb-14", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-gold text-xs tracking-[0.25em] font-semibold uppercase mb-2", children: number }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-2xl md:text-3xl lg:text-4xl font-bold uppercase tracking-wider text-foreground mb-3", children: title }),
    subtitle && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-custom text-sm md:text-base tracking-wide", children: subtitle })
  ] });
}
function AmenityCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface-2 border border-[oklch(0.25_0.006_220)] rounded p-4 flex flex-col items-center gap-3 text-center hover:border-gold-bright transition-colors duration-300", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "text-gold w-5 h-5 flex-shrink-0" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-semibold uppercase tracking-wide text-foreground leading-relaxed", children: label })
  ] });
}
function AddOnCard({
  name,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-surface border border-[oklch(0.22_0.005_220)] rounded p-5 flex items-center justify-between gap-4 hover:border-gold transition-colors duration-300 group", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Icon2, { className: "text-gold w-4 h-4 flex-shrink-0" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-foreground", children: name })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-bold text-sm whitespace-nowrap", children: price })
  ] });
}
function PolicyBlock({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      className: `flex gap-4 p-5 rounded border ${highlight ? "border-[oklch(0.60_0.12_60_/_0.5)] bg-[oklch(0.18_0.01_60_/_0.3)]" : "border-[oklch(0.22_0.005_220)] bg-surface"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Icon2,
          {
            className: `w-5 h-5 flex-shrink-0 mt-0.5 ${highlight ? "text-destructive" : "text-gold"}`
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-bold uppercase tracking-wider text-foreground mb-1", children: title }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: description })
        ] })
      ]
    }
  );
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm md:text-base font-semibold uppercase tracking-wide text-foreground", children: question }),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                ChevronDown,
                {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "px-5 md:px-6 pb-5 md:pb-6", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-[oklch(0.22_0.005_220)] mb-4" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: answer })
            ] })
          }
        )
      ]
...
function Header() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-[oklch(0.10_0.005_220_/_0.97)] border-b border-gold" : "bg-transparent border-b border-transparent"}`,
      "data-ocid": "nav.section",
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-6 md:px-12 py-4 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
              href: "#home",
              ...
              "data-ocid": "nav.link",
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-black text-sm tracking-[0.3em] uppercase", children: "HOMEBASE" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-light text-xs tracking-[0.45em] uppercase mt-0.5", children: "STUDIOS" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        mobileOpen && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-[oklch(0.10_0.005_220_/_0.98)] border-t border-gold", children: /* @__PURE__ */ jsxRuntimeExports.jsx("nav", { className: "flex flex-col py-4", "aria-label": "Mobile navigation", children: navLinks.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "a",
          {
            href: link.href,
            onClick: (e) => handleNavClick(e, link.href),
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "url('/assets/studio-019d5395-8e8c-7788-9a91-38fca4fea307.jpg')",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(to bottom, rgba(11,15,16,0.75) 0%, rgba(11,15,16,0.55) 50%, rgba(11,15,16,0.85) 100%)"
            },
            "aria-hidden": "true"
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative z-10 text-center px-6 max-w-4xl mx-auto", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Quick Guide for Your Studio Rental"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "h1",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold", children: "STUDIOS" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                width: "80px",
                height: "1px",
                background: "linear-gradient(90deg, transparent, oklch(0.72 0.13 65), transparent)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Before You Shoot: Guide & Policies"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "p",
            {
              ...
              children: "Access • Timing • Amenities • Add-Ons • FAQs"
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronDown, { className: "w-6 h-6 text-gold animate-bounce" })
            }
          )
        ] })
      ]
...
function App() {
  ...
  const faqs = [
    {
      ...
      answer: "No. All setup, shooting, and breakdown must be included in your booked time. There are no exceptions to this policy."
    },
    {
      id: "extra-time",
      question: "What if I need additional time?",
      answer: "Additional time is $33 per 30-minute increment. Note this may not be available if another session is scheduled after yours. Please plan accordingly."
    },
    {
      id: "furniture",
      question: "Can I move furniture or studio items?",
      answer: "Yes, as long as everything is returned to its original position before your booking ends. Do not drag furniture or props on the Cyc floor — any damage will be assessed to the renter."
    },
    {
      id: "props",
      question: "Do you provide props?",
      answer: "Studio sessions include basic seating props. Clients are welcome to bring their own props for any session. Do not drag furniture or props on the Cyc floor. Any damage will be assessed to the renter."
    },
    {
      id: "reschedule",
      question: "What if I need to reschedule or cancel?",
      answer: "Please review the Peerspace Cancellation and Refund policy, which governs all bookings made through the platform."
    },
    {
      id: "late",
      question: "What if I'm running late?",
      answer: "We understand unexpected events happen. Please notify Homebase Studios in advance. Arriving late does not mean you can extend your session for free. Additional time is $33 per 30-minute increment (subject to availability)."
    },
    {
      id: "staff",
      question: "Is staff on-site during my booking?",
      answer: "Staff may not be on-site for all bookings. Self-guided access instructions are provided to help you access the building and studio independently."
    },
    {
      id: "pets",
    ...
    },
    {
      ...
      answer: "Maximum occupancy is based on your Peerspace booking. Additional guests beyond your booking may require prior approval."
    }
  ];
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-background text-foreground", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "access", className: "bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeading,
        {
          number: "01",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 p-6 bg-surface border border-[oklch(0.22_0.005_220)] rounded", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "text-gold w-5 h-5 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold uppercase tracking-[0.2em] text-gold", children: "How to Get Here" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-foreground mb-2", children: "Address" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-custom leading-relaxed mb-4", children: [
              "VAPA Center",
              /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-foreground mb-1", children: "By Car" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: "Head to 700 N. Tryon St in uptown Charlotte. Turn into the VAPA Center driveway. Park anywhere inside the gated parking lot — not the Sheriff's Dept side." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-foreground mb-1", children: "Once Inside" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: "Homebase Studios is on the main floor of the VAPA Center. Go through the door past the elevator — the studio is the first door on the right." })
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-foreground mb-1", children: "Exit Route" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: "Please exit only via Montford Point." })
            ] })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6 p-6 bg-surface border border-[oklch(0.22_0.005_220)] rounded", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "text-gold w-5 h-5 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold uppercase tracking-[0.2em] text-gold", children: "Guest Check-In" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-3", children: checkInSteps.map((step, i) => (
          // biome-ignore lint/suspicious/noArrayIndexKey: static ordered list
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "flex-shrink-0 w-5 h-5 rounded-full border border-gold text-gold text-[10px] font-bold flex items-center justify-center mt-0.5", children: i + 1 }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: step })
          ] }, i)
        )) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-10 p-6 bg-surface border border-[oklch(0.22_0.005_220)] rounded", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "text-gold w-5 h-5 flex-shrink-0" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "text-sm font-bold uppercase tracking-[0.2em] text-gold", children: "Studio Location" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("ul", { className: "space-y-3", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold mt-1 flex-shrink-0", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: "Homebase Studios is located on the Main floor of the VAPA Center." })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("li", { className: "flex items-start gap-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold mt-1 flex-shrink-0", children: "•" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: "Go through the door past the elevator — the studio is the first door on the right." })
          ] })
        ] })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-8 md:gap-12 items-start", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-custom leading-relaxed mb-6", children: "Welcome to Homebase Studios at the VAPA Center in uptown Charlotte. We want your session to start smoothly — please review the access details above before your arrival." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "a",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "text-gold w-5 h-5 flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold mb-1", children: "Entrance" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: "VAPA Center entrance is located on College Street" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Car, { className: "text-gold w-5 h-5 flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold mb-1", children: "Parking" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: "Park anywhere inside the gated parking lot (not the Sheriff's Dept side)" })
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-4 items-start", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Navigation, { className: "text-gold w-5 h-5 flex-shrink-0 mt-0.5" }),
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold mb-1", children: "Exit" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom leading-relaxed", children: "Please exit only via Montford Point" })
            ] })
          ] })
        ] })
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "booking", className: "bg-surface", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeading,
        {
          number: "02",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6", children: [
        ...
        "div",
        {
          ...
          "data-ocid": item.ocid,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Clock, { className: "text-gold w-6 h-6" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs font-bold uppercase tracking-wider text-foreground leading-relaxed", children: item.label })
          ]
        },
        item.id
      )) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-6 text-xs text-muted-custom tracking-wide", children: "* Final breakdown should be completed before your scheduled end time." })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "amenities", className: "bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeading,
        {
          number: "03",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 md:gap-4", children: amenities.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `amenities.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(AmenityCard, { icon: item.icon, label: item.label }) }, item.id)) })
    ] }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "addons", className: "bg-surface", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeading,
        {
          number: "04",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid md:grid-cols-2 gap-3", children: addons.map((item, i) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { "data-ocid": `addons.item.${i + 1}`, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
        AddOnCard,
        {
          name: item.name,
          price: item.price,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "policies", className: "bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { number: "05", title: "Studio Policies" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          PolicyBlock,
          {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "faq", className: "bg-surface", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-4xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { number: "06", title: "Frequently Asked Questions" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-2", "data-ocid": "faq.list", children: faqs.map((faq, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
        FAQItem,
        {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Section, { id: "contact", className: "bg-background", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-6xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        SectionHeading,
        {
          number: "07",
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid md:grid-cols-2 gap-6 max-w-2xl", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            href: "tel:9196857780",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Phone, { className: "text-gold w-5 h-5 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold mb-0.5", children: "Phone" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom group-hover:text-foreground transition-colors", children: "(919) 685-7780" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            "data-ocid": "contact.link",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "text-gold w-5 h-5 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold mb-0.5", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom group-hover:text-foreground transition-colors", children: "Homebasemg@gmail.com" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            "data-ocid": "contact.link",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(Globe, { className: "text-gold w-5 h-5 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold mb-0.5", children: "Website" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-custom group-hover:text-foreground transition-colors", children: "www.homebasefilms.com" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(MapPin, { className: "text-gold w-5 h-5 flex-shrink-0" }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs font-bold uppercase tracking-wider text-gold mb-0.5", children: "Address" }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-custom leading-relaxed", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(GoldDivider, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "bg-[oklch(0.09_0.004_220)] py-10 px-6 md:px-12", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-6 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col leading-none", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-gold font-black text-xs tracking-[0.3em] uppercase", children: "HOMEBASE" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-muted-custom font-light text-xs tracking-[0.45em] uppercase mt-0.5", children: "STUDIOS" })
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "h-px bg-[oklch(0.18_0.005_220)] mb-6" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-3 text-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-custom tracking-wide", children: [
          "© ",
          year,
          " Homebase Studios. All rights reserved."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-xs text-muted-custom tracking-wide", children: [
          "Built with ",
...
const BookingInformation = Record({ "text": Text });
const ContactInformation = Record({
  "mail": Text,
  "address": Text,
  "phone": Text
});
Service({
  "getBookingInformation": Func([], [BookingInformation], ["query"]),
  "getContactInformation": Func([], [ContactInformation], ["query"])
});
